...
const menuItems = [
  ...
  { id: 2, label: "", icon: ArticleIcon, link: "/demande_stage" },
//   { id: 3, label: "Listes des C.charge en attente", icon: UsersIcon, link: "/users" },
//   { id: 3, label: "Ajouter des Encadrant", icon: UsersIcon, link: "/users" },
  // { id: 4, label: "Manage Tutorials", icon: VideosIcon, link: "/tutorials" },
];

export default function IsLoadingSideBar({user =[]}){
