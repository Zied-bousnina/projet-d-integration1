...
const menuItems = [
  ...
  { id: 2, label: "Consulter Liste des PFE", icon: ArticleIcon, link: "/Encadrant/ConsultDemandePFE" },
  { id: 3, label: "Liste des Etudiant Accepter", icon: ArticleIcon, link: "/Encadrant/ListEtudiantAccepter" },

  // { id: 4, label: "Manage Tutorials", icon: VideosIcon, link: "/tutorials" },
];

export default function SideBarProf({user =[]}){
